...
INT WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInst, LPSTR IpCmdLine, INT nCmdShow)
{
	...
	wc.hIcon = LoadIcon(hInstance, IDI_APPLICATION);	//Иконка отображаемая в панеле задач
	wc.hIconSm = LoadIcon(hInstance, IDI_APPLICATION);	//Иконка отображаемая в страке заголовка
